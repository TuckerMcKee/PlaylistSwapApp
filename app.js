...
import ultimateGuitarRoutes from './server/routes/ultimateGuitar.js';
import redisSession from './server/middleware/session.js';
import { CLIENT_URL, NODE_ENV } from './server/config/index.js';
...
app.use('/ultimateguitar',ultimateGuitarRoutes);
